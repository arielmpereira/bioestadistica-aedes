...
En las tres respuestas, el menor AIC correspondió al modelo binomial negativo inflado en ceros (ZIMB). Esto indicó que, para estos datos, el modelo ZINB representaba mejor la combinación de sobredispersión y exceso de ceros. Por eso usamos esta familia de modelos para continuar el análisis.
...
Como se ajustaron seis modelos, en el informe resumimos los diagnósticos en una tabla general y la siguiente imágen muestra un gráfico representativo. En este caso se trata del diagnóstico del modelo Macrohabitat para la abundancia total.

Los gráficos completos de residuos se dejan en QMD del modelado de abundancia includo en el anexo del informe.

![](images/clipboard-605720505.png)

Figura : Diagnostico con DHARMa del modelo macrohabitat de abundancia total

### Tabla resumen de diagnosticos por DHARMa de los 6 modelos
...
Tabla: Resumen de los diagnósticos por DHARMa de los 6 modelos
